        ...
        setContent {
            MyJetPackTheme {
                ...
                Surface(
                    ...
                    val students = listOf("John","Mary","Sam","Simon",
                                            "June","Robi","Alice","Faith",
                                            "Pamela","Felix","Vernon","Edwin")
                    LazyHome(students)
...
Box (modifier = Modifier.fillMaxSize()){
    Image(
        painter = painterResource(id = R.drawable.citynight),
...
fun LazyHomePreview(){
    MyJetPackTheme {
        val students = listOf("James","Robi","June","Mark","John")
        LazyHome(students)
    }
}